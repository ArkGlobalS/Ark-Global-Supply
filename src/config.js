// =============================================
// ARK GLOBAL SUPPLY - CONFIGURATION V3
// =============================================
...
export const SITE = {
  ...
  // SALE END DATE - Set a fixed date (will persist across refreshes)
  saleEndDate: '2025-01-15T23:59:59+11:00', // Change this to your actual sale end date
  shipping: {
    freeThreshold: 100,
    rates: {
      AU: {
...
// =============================================
// PRODUCTS - BLUEY BUNDLE IN STOCK, ALL OTHERS SOLD OUT
// =============================================

export const PRODUCTS = [
  // ========== KIDS COLLECTION - BLUEY BUNDLE IN STOCK ==========
  {
    id: 300,
...
images: [
  "https://i.ibb.co/7t8tKxWT/bluey-bundle.png"
],
    ],
    tag: "🔥 ONLY 5 LEFT",
    tagBg: "#EF4444",
  ...
  // ========== MEN'S COLLECTION - ALL SOLD OUT ==========
  {
    ...
    stock: 0,
    sold: 2341,
    reviews: [{ u: "Jake M.", r: 5, t: "Beast mode activated!", v: true }],
    related: [102, 104, 109]
  },
  {
    id: 102,
  ...
  // ========== WOMEN'S COLLECTION - ALL SOLD OUT ==========
  {
    id: 201,
  ...
  // ========== KIDS COLLECTION - ALL SOLD OUT EXCEPT BLUEY ==========
  {
    id: 301,
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1567168544813-cc03465b4fa8?w=800"],
    tag: "SOLD OUT",
    tagBg: "#555555",
    cat: "kids",
    stock: 0,
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1513807016779-d51c0c026263?w=800"],
    tag: "SOLD OUT",
    tagBg: "#555555",
    cat: "kids",
    stock: 0,
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1492725764893-90b379c2b6e7?w=800"],
    tag: "SOLD OUT",
    tagBg: "#555555",
    cat: "gifts",
    stock: 0,
